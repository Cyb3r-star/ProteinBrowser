...
#print(new_protein.accession, new_protein.name, new_protein.description, new_protein.peptides, new_protein.PSMs, new_protein.ratios_raw, "\n")

    row_count += 1

#Exporting spreadsheet data to a SQLite database
